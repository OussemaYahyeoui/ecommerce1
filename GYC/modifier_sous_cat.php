                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group" row>
                                        <input type="hidden" name="id" value="<?php echo($result->sous_cat_id) ;?>">
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nom :</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" value="<?php echo($result->sous_cat_title) ;?>" name="nom">
                                        </div>
                                    </div>
...
if (isset($_POST['b1'])) {
       ...
       $nom = $_POST["nom"] ;
       $id= $_POST["id"];
   $insert_cat = "UPDATE  sous_categorie SET sous_cat_title='$nom' where sous_cat_id ='$id'";

    $insert_pro = mysql_query ($insert_cat ,$con);
    if ($insert_pro) {
