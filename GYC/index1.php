                    ...
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-cyan text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-view-dashboard"></i><?php
...
mysqli_close($con); ?>
                               ...
                               <h6 class="text-white">Nombre des produits totale </h6></h1>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
...
mysqli_close($con); ?>
                                ...
                                <h6 class="text-white">Nombre des utilisateurs</h6>
                            </div>
                        </div>
                    </div>
                     <!-- Column -->
...
mysqli_close($con); 
                                ...
                                <h6 class="text-white">Nombre des catégories</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                ...
                                <h6 class="text-white">Nombre des marques</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                            ...
                            <div class="box bg-info text-center">
                                <h1 class="font-light text-white"><i class="mdi mdi-arrow-all"></i>
                                    <?php
                                        ...
                                        $sql = "SELECT sous_cat_id From sous_categorie";
                                        if ($res=mysqli_query($con,$sql))
                                          {
                                          // Return the number of rows in result set
                                          $rowcount=mysqli_num_rows($res);
                                ...
                                <h6 class="text-white"> Nombre de sous categorie</h6>
                            </div>
                        </div>
                    </div>
                                        -->
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                ...
                                <h6 class="text-white">Nombre des admins</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
            ...
            <footer class="footer text-center">
                 Designed and Developed by <a href="#">Oussema Yahyaoui</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
