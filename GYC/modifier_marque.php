                            ...
                            <form class="form-horizontal" enctype="multipart/form-data" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group" row>
                                        <input type="hidden" name="id" value="<?php echo($result->brand_id) ;?>">
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nom :</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" value="<?php echo($result->brand_title) ;?>" name="nom">
                                        </div>
                                    </div>
...
if (isset($_POST['b1'])) {
       ...
       $nom = $_POST["nom"] ;
       $id= $_POST["id"];
   $insert_marque = "UPDATE  brands SET brand_title='$nom' where brand_id ='$id'";

    $insert_pro = mysqli_query ($con,$insert_marque);
    if ($insert_pro) {
...
?>
            ...
            <footer class="footer text-center">
                All Rights Reserved by GYC Tech. Designed and Developed by <a href="https://perfecto.com">Rerfect Web Technology</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
