...
<?php
       if(isset($_GET['idCmnd']))
       {
           $id=$_GET['idCmnd'];
        $sql ="SELECT * from commande_item2 WHERE Idcmnd='$id' ";
                                ...
                                <div class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered">
                                     ...
                                     <?php
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>&nbsp <b><?php echo $r['ID'];?>&nbsp </b></td>
                                                <td>&nbsp <b><?php echo $r['produit'];?>&nbsp </b></td>
                                                <td>&nbsp <b><?php echo $r['QT'];?>&nbsp </b></td>
                                                <td>&nbsp <b><?php echo $r['prixCommande'];?>&nbsp </b></td>
                                                <td>&nbsp <b><?php echo $r['etat'];?>&nbsp </b></td>
