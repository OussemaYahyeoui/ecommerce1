                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nom Catégorie:</label>
                                        <div class="col-sm-9">
...
if (isset($_POST['b1'])) {
   ...
   $insert_cat = "INSERT into categories (cat_title) values ('$nom')";
...
<br><br><br>
            ...
            <footer class="footer text-center">
                All Rights Reserved . Designed and Developed by oussema yahyaoui
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
