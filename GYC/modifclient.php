...
$con=mysqli_connect("localhost","root","","pff");
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" action="modifclient2.php" method="POST">
                                <div class="card-body">
                                    <h4 class="card-title">Modifier Clients :</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" value="<?php echo($result->customer_name) ;?>" name="customer_name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Prenom :</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" value="<?php echo($result->customer_prenom) ;?>" name="customer_prenom">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Adresse :</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" value="<?php echo($result->customer_adresse) ;?>" name="customer_adresse">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Téléphone :</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="email1" value="<?php echo($result->customer_tel) ;?>" name="customer_tel">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Email :</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="email1" value="<?php echo($result->customer_email) ;?>" name="customer_email">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">Password</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="email1" value="<?php echo($result->customer_password) ; }?>" name="customer_password">
                                        </div>
                                    </div>
                                </div>
