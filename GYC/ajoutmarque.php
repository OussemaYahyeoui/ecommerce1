                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Nom du marque:</label>
                                        <div class="col-sm-9">
...
if (isset($_POST['b1'])) {
   ...
   $insert_brand = "INSERT into brands (brand_title) value ('$nom')";

    $insert_pro = mysqli_query ($con,$insert_brand);
    if ($insert_pro) {
        echo "<script>alert('ajout à éte effectuer')</script>";
...
<br><br><br>
            ...
            <footer class="footer text-center">
                All Rights Reserved by GYC Teck. Designed and Developed by <a href="https://wrappixel.com">WrapPixel</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
