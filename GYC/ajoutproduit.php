        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" method="post" action="inser.php" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname"  name="product_title">
                                        </div>
                                    </div>
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <input type="submit" name="insert_post"class="btn btn-primary"> 
                                    </div>
                                </div>
                            </form>
                        </div>
            ...
            <footer class="footer text-center">
                All Rights Reserved Designed and Developed by <a href="https://wrappixel.com">Oussema Yahyaoui</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
