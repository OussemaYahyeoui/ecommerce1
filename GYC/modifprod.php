            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                 <?php
                        $id = $_GET["idProd"] ;
                        //requête SQL:
                        $sql = "SELECT * FROM produit WHERE product_id = ".$id ;
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" action="modifprod2.php" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" value="<?php echo($result->product_name) ;?>" name="product_name">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">code :</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" value="<?php echo($result->product_id) ;?>" name="product_id">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="email1" class="col-sm-3 text-right control-label col-form-label">quantite :</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="email1" value="<?php echo($result->product_quantity) ;?>" name="product_quantite">
                                        </div>
                                    </div>
                                                ...
                                                <?php 
                                                     ...
                                                     $run_marq = mysqli_query($con,$get_marq);
                                                        ...
                                                        while ( $row_marq=mysqli_fetch_array($run_marq)) 
                                                        {
                                                          ...
                                                          $marq_title = $row_marq ['marque_nom'];

                                                          echo "<option value=$marq_id>$marq_title</option>";
                                                         }
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="file" name="product_image" /><img src="files/<?php echo $result->product_image; ?>" width="60" height="60"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Prix avec promotion :</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="prix_promotion" value="<?php echo($result->prix_promotion) ;?>"  />
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Description produit:</label>
                                        <div class="col-sm-9">
                                            <textarea name="product_desc" cols="20" rows="10" value="<?php echo($result->product_desc) ;?>" ></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Mots clé :</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="product_keywords" size="50" value="<?php echo($result->product_keywords) ;}?>"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="border-top">
                                    <div class="card-body">
                                        <input type="submit" name="b1"class="btn btn-primary" value="Modifier"> 
                                    </div>
                                </div>
                            </form>
                        </div>
